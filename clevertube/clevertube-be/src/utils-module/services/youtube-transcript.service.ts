...
export class YoutubeTranscriptService {
  ...
  async fetchTranscript(
    ...
    try {
      const res = await axios(`https://www.youtube.com/watch?v=${identifier}`);
   ...
   * @param config
   */
  private generateRequest(page: string, config?: TranscriptConfig) {
   ...
   */
  private retrieveVideoId(videoId: string) {
