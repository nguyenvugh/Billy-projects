...
function Autocomplete({ required, error, labelName, id, data, placeholder, onChange, defaultValue, disabled }) {
  ...
  return <div className={classes.root}>
    <div {...getRootProps()}>
      ...
      <InputBase
        disabled={disabled}
        value={inputValueState} placeholder={placeholder} className={`${classes.input} ${isError && classes.inputError}`} inputProps={{ ...getInputProps() }}
        endAdornment={
