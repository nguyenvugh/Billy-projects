...
function Input({ id, defaultValue, labelName, placeholder, inputSuffix, onChange, readOnly, error, required, type, inputFormat }) {
  ...
  const handleChange = (event) => {
    ...
    onChange && onChange(valueReplaced.trim());
  };
