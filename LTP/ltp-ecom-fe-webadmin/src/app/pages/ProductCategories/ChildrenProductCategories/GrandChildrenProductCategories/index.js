...
export default function GrandChildrenProductCategories() {
  ...
  const [parentTile1, setParentTitle1] = useState("");
  ...
  useEffect(() => {
    getProductCategory(
      Utils.replaceStrUrl(AppURL.deleteProductCategory, [grandChildrenId])
    ).then((res) => {
  ...
  const handleOpenAddModal = () => {
    setDetailForm({
      product_category_parent: grandChildrenId,
      product_category_name: "",
      product_category_code: "",
          ...
          <div className="page-header">
            <div className="page-title">
              <Breadcrumbs>
                ...
                <Link to={`${urlProductCategory}/${id}`}>{parentTile1}</Link>
