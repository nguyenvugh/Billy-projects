...
import { workingDate } from "../ShopCard";
...
class Map extends PureComponent {
  ...
  componentDidUpdate(preProps) {
    if (preProps.shopList !== this.props.shopList) {
      this.updateMarker();
  ...
  getContentString = ({
    ...
    <div style="font-size: 14px; font-family: 'Montserrat'; margin-top: 4px;">Điện thoại: ${phone_number}</div>
    <div style="font-size: 14px; font-family: 'Montserrat'; margin-top: 4px;">Giờ mở cửa: 
    ${workingDate[start_working_date]} đến ${workingDate[end_working_date]} (${start_working_time} - ${end_working_time})
    </div>`;
